            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="md:flex md:justify-between">
                        ...
                        <div class="md:w-1/2 md:ml-4">
                            ...
                            <div class="flex justify-around items-center">
                                <div>
                                    <span class="title-font font-medium text-2xl text-gray-900">{{ number_format($product->price) }}<span class="text-sm text-gray-700">円（税込）</span>
                                </div>
                    ...
                    <div class="border-t border-gray-400 my-8">
                        <div class="mt-4 mb-4 text-center">この商品を販売しているショップ</div>

<x-app-layout>
    ...
    <div class="flex mt-4 items-center text-sm font-medium justify-around">
        <button type="button" onclick="location.href='{{ route('user.items.index') }}'" class="text-black bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button>
    </div>
    ...
    <form method="POST" action="{{ route('user.confirm', ['user' => $user->id]) }}">
      @csrf
